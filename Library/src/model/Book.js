...
Book.createTestData = function () {
  Book.instances["006251587X"] = new Book({isbn:"006251587X", title:"Titanic", year:2000});
  Book.instances["0465026567"] = new Book({isbn:"0465026567", title:"Love", year:1999});
  Book.instances["0465030793"] = new Book({isbn:"0465030793", title:"Dictionary", year:2008});
  Book.saveAll();
};
//  Clear data
Book.clearData = function () {
  if (confirm("Do you really want to delete all book datas?")) {
    Book.instances = {};
